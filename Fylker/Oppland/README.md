...
<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oppland/Oppland Næringsområder (merking) Andel i prosent av sum merket beløp for alle NFR prosjekter startet i året (heatmap).png">![Foo](Oppland Næringsområder (merking) Andel i prosent av sum merket beløp for alle NFR prosjekter startet i året (heatmap).png)</a>

<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oppland/Oppland Næringsområder (merking) Andel i prosent av sum merket beløp for alle NFR prosjekter startet i året (linjer).png">![Foo](Oppland Næringsområder (merking) Andel i prosent av sum merket beløp for alle NFR prosjekter startet i året (linjer).png)</a>

<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oppland/Oppland Fylkets andel av totalt omsøkt skattefradrag i godkjente nye prosjekter startet i året (heatmap).png">![Foo](Oppland Fylkets andel av totalt omsøkt skattefradrag i godkjente nye prosjekter startet i året (heatmap).png)</a>

<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oppland/Oppland Fylkets andel av totalt omsøkt skattefradrag i godkjente nye prosjekter startet i året (linjer).png">![Foo](Oppland Fylkets andel av totalt omsøkt skattefradrag i godkjente nye prosjekter startet i året (linjer).png)</a>

<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oppland/Oppland NFR og SF andel av totalt omsøkt eller innvilget beløp for nye prosjekter startet i året (heatmap).png">![Foo](Oppland NFR og SF andel av totalt omsøkt eller innvilget beløp for nye prosjekter startet i året (heatmap).png)</a>
...
<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oppland/Oppland NIFU FoU Statistikk Prosentandel av total for hele landet (heatmap).png">![Foo](Oppland NIFU FoU Statistikk Prosentandel av total for hele landet (heatmap).png)</a>

<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oppland/Oppland NIFU FoU Statistikk Prosentandel av total for hele landet (linjer).png">![Foo](Oppland NIFU FoU Statistikk Prosentandel av total for hele landet (linjer).png)</a>

<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oppland/Oppland Andel av totalt antall sysselsatte i næringen som jobber i fylket (heatmap).png">![Foo](Oppland Andel av totalt antall sysselsatte i næringen som jobber i fylket (heatmap).png)</a>

<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oppland/Oppland Andel av totalt antall sysselsatte i næringen som jobber i fylket (linjer).png">![Foo](Oppland Andel av totalt antall sysselsatte i næringen som jobber i fylket (linjer).png)</a>

<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oppland/Oppland Bruttoprodukt (milliarder) (heatmap).png">![Foo](Oppland Bruttoprodukt (milliarder) (heatmap).png)</a>
