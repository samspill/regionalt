...
<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oslo/Oslo Fylkets andel av totalt omsøkt skattefradrag i godkjente nye prosjekter startet i året (heatmap).png">![Foo](Oslo Fylkets andel av totalt omsøkt skattefradrag i godkjente nye prosjekter startet i året (heatmap).png)</a>

<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oslo/Oslo Fylkets andel av totalt omsøkt skattefradrag i godkjente nye prosjekter startet i året (linjer).png">![Foo](Oslo Fylkets andel av totalt omsøkt skattefradrag i godkjente nye prosjekter startet i året (linjer).png)</a>

<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oslo/Oslo NFR og SF andel av totalt omsøkt eller innvilget beløp for nye prosjekter startet i året (heatmap).png">![Foo](Oslo NFR og SF andel av totalt omsøkt eller innvilget beløp for nye prosjekter startet i året (heatmap).png)</a>
...
<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oslo/Oslo NIFU FoU Statistikk Prosentandel av total for hele landet (heatmap).png">![Foo](Oslo NIFU FoU Statistikk Prosentandel av total for hele landet (heatmap).png)</a>

<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oslo/Oslo NIFU FoU Statistikk Prosentandel av total for hele landet (linjer).png">![Foo](Oslo NIFU FoU Statistikk Prosentandel av total for hele landet (linjer).png)</a>

<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oslo/Oslo Andel av totalt antall sysselsatte i næringen som jobber i fylket (heatmap).png">![Foo](Oslo Andel av totalt antall sysselsatte i næringen som jobber i fylket (heatmap).png)</a>

<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oslo/Oslo Andel av totalt antall sysselsatte i næringen som jobber i fylket (linjer).png">![Foo](Oslo Andel av totalt antall sysselsatte i næringen som jobber i fylket (linjer).png)</a>

<a href="https://raw.githubusercontent.com/samspill/regionalt/master/Fylker/Oslo/Oslo Bruttoprodukt (milliarder) (heatmap).png">![Foo](Oslo Bruttoprodukt (milliarder) (heatmap).png)</a>
